...
const String searchYourCompanyKey = "searchYourCompany";
const String noDataFoundKey = "noDataFound";
const String attendanceAppKey = "attendanceApp";
...
const String classUserKey = "classUser";
